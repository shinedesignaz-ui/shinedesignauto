(() => {
    ...
    <div class="wrap">
      <div class="row">
        <a class="brand" href="/" aria-label="ShineDesign Home">
          <img src="/logo.ico" alt="ShineDesign"><div><div class="n">ShineDesign</div><div class="t">DETAILING • TINT • PPF • CERAMIC</div></div>
        </a>
  ...
  // Inject at runtime
  document.addEventListener('DOMContentLoaded', () => { if(document.querySelector('header.site-chrome')) return;
